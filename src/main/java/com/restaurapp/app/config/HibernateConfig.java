...
public class HibernateConfig {
	...
	public LocalSessionFactoryBean hibernateSessionFactory(DataSource ds) {
		...
		sessionFactory.setPackagesToScan("com.restaurapp.app"); //skenira sve pakete
	...
	public DataSource dataSource() { //podesavanje datasource (postavljanje jdbc konekcije i jdbc drivera)
		...
		dataSource.setUrl("jdbc:sqlserver://localhost:1433;databaseName=Restoran1;integratedSecurity=true;");
		return dataSource;
	}
